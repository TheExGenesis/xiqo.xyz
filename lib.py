...
class NotionWebsiteBuilder:
    ...
    def loadCache(self):
        ...
        if os.path.exists(cache_path):
            with open(cache_path, 'r', encoding='utf-8') as f:
                self.old_cache = json.loads(str(f.read()))#, 'utf-8'))# 'utf-8'))
    ...
    def renderPage(self, page, data={}):
        ...
        template_name = page['template'] if page['template'] is not None and page['template'] != '' else 'default'
            ...
            for prop in props:
                ...
                if prop_type in templates['text']:
                    ...
                    if prop_type == 'a':            # external link
                        ...
                        if re.search(r'^(https://xiqo\.xyz)', data['href']) is not None:
